<div class="max-w-4xl px-4 py-10 mx-auto">
    <h2 class="mb-6 text-2xl font-bold">Form Retur Barang</h2>
        ...
        @foreach($order->orderItems as $item)
            <div class="pb-4 mb-4 border-b">
                <label class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold">{{ $item->laptop->brandRelation->brand_name ?? '' }} {{ $item->laptop->model }}</p>
                        ...
                        <div class="mt-2" x-show="returnItems.{{ $item->id }}.return">
                            ...
                            <input type="text" wire:model="returnItems.{{ $item->id }}.condition"
